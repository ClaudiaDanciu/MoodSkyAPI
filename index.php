...
<body>
    ...
    <div class="main-container container">
        <div class="row">
        <a class="navbar-brand " href="index.php"><img class="logo" src="images/SkyEmotion@1x.png" style="height: 30px; text-align: center;" alt="logo"></a>
        </div>
        <div class="row">
    ...
    ?>
        ...
        <script>
            var image = "";
var title = "";
var moods = ["Joy", "Surprise", "Sadness", "Anger", "Disgust", "Fear"];
datasets = [{
	        name: 'Joy:',
	        data: dataJoy},
	    {
